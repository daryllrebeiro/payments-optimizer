...
import type { Result, Clock } from '@payments-optimizer/resilience';
import { ok, err, getClock } from '@payments-optimizer/resilience';
import { DomainError, isDomainError } from '@payments-optimizer/resilience';
